...
<div class='wrapper'>
    <div class='pad1'>
        <h1>
            <a href="../../index.html">all files</a> / <a href="index.html">nock/lib/</a> request_overrider.js
        </h1>
        <div class='clearfix'>
            <div class='fl pad1y space-right2'>
                <span class="strong">93.85% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>244/260</span>
            </div>
            <div class='fl pad1y space-right2'>
                <span class="strong">88.24% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>150/170</span>
            </div>
            <div class='fl pad1y space-right2'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>242/256</span>
            </div>
        </div>
    </div>
...
&nbsp;
  ...
  request._removedHeader = request._removedHeader || <span class="branch-1 cbranch-no"
...
<span class="cstat-no"
      title="statement not covered">      options.headers[HOST_HEADER] = interceptor.__nock_scopeHost;</span>
    }
...
<span class="cstat-no" title="statement not covered">    response._read = <span class="fstat-no"
...
&nbsp;
    ...
    response.statusCode = Number(interceptor.statusCode) || <span class="branch-1 cbranch-no"
                                                                  title="branch not covered">200;</span>
&nbsp;
...
&nbsp;
            ...
            typeof responseBody[0] == 'number')
        {
          ...
          <span class="missing-if-branch" title="if path not taken">I</span>if (! response.headers) <span
                    class="cstat-no" title="statement not covered">response.headers = {};</span>
          _.assign(response.headers, responseBody[2] || {});
          debug('response.headers after: %j', response.headers);
          responseBody = responseBody[1];
&nbsp;
          response.rawHeaders = response.rawHeaders || <span class="branch-1 cbranch-no"
                                                             title="branch not covered">[];</span>
...
&nbsp;
      ...
      interceptor.discard();
&nbsp;
      <span class="missing-if-branch" title="if path not taken">I</span>if (aborted) { <span class="cstat-no"
                                                                                             title="statement not covered">return; </span>}
&nbsp;
      /// response.client.authorized = true
      /// fixes https://github.com/pgte/nock/issues/158
      response.client = _.extend(response.client || <span class="branch-1 cbranch-no"
                                                          title="branch not covered">{},</span> {
        authorized: true
      });
&nbsp;
      ...
      response.socket = _.extend(response.socket || <span class="branch-1 cbranch-no"
                                                          title="branch not covered">{},</span> {
        authorized: true
      });
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
    Code coverage
    generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Apr 06 2016 10:42:20 GMT+0100
    (BST)
</div>
</div>
