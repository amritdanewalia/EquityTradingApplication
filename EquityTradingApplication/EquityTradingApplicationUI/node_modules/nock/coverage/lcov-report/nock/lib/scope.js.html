...
<div class='wrapper'>
    <div class='pad1'>
        <h1>
            <a href="../../index.html">all files</a> / <a href="index.html">nock/lib/</a> scope.js
        </h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>162/175</span>
            </div>
        </div>
    </div>
...
<pre><table class="coverage">
    <tr>
        ...
        <td class="text"><pre class="prettyprint lang-js">/* jshint strict:false */
/**
 * @module nock/scope
 */
...
&nbsp;
Scope.prototype.patch = <span class="fstat-no"
                              title="function not covered">function patch(uri, requestBody, options) {</span>
<span class="cstat-no" title="statement not covered">  return this.intercept(uri, 'PATCH', requestBody, options);</span>
};
&nbsp;
Scope.prototype.merge = <span class="fstat-no"
                              title="function not covered">function merge(uri, requestBody, options) {</span>
...
<span class="cstat-no"
      title="statement not covered">      if (parseInt(options.port) !== parseInt(nockDef.port)) {</span>
...
&nbsp;
    var nscope     = getScopeFromDefinition(nockDef)
      , npath      = nockDef.path
      , method     = nockDef.method.toLowerCase() || <span class="branch-1 cbranch-no"
                                                           title="branch not covered">"get"</span>
...
<span class="cstat-no" title="statement not covered">      nock = startScope(nscope, options).filteringRequestBody(<span
