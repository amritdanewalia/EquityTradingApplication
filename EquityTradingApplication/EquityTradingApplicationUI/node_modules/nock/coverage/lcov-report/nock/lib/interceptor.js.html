...
<div class='wrapper'>
    <div class='pad1'>
        <h1>
            <a href="../../index.html">all files</a> / <a href="index.html">nock/lib/</a> interceptor.js
        </h1>
        <div class='clearfix'>
...
Interceptor.prototype.match = function match(options, body, hostNameOnly) {
    <span class="missing-if-branch" title="if path not taken">I</span>if (debug.enabled) {
...
&nbsp;
    ...
    if (this.__nock_filteredScope) {
        ...
        <span class="missing-if-branch" title="if path not taken">I</span>if (
            ...
            (<span class="branch-2 cbranch-no" title="branch not covered">options.port !== 80 </span>|| <span
                    class="branch-3 cbranch-no" title="branch not covered">options.proto !== 'http')</span> &amp;&amp;
            (<span class="branch-4 cbranch-no" title="branch not covered">options.port !== 443 </span>|| <span
                    class="branch-5 cbranch-no" title="branch not covered">options.proto !== 'https')</span>
        ) {
...
&nbsp;
Interceptor.prototype.filteringPath = <span class="fstat-no"
                                            title="function not covered">function filteringPath() {</span>
