...
<div class="header medium">
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">nock/lib/</a> &#187;
        recorder.js
    </div>
</div>
<div class="body">
...
<span class="branch-1 cbranch-no" title="branch not covered">     options.port </span>&amp;&amp;
     ((<span class="branch-2 cbranch-no" title="branch not covered">options._https_ </span>&amp;&amp; <span
                    class="branch-3 cbranch-no" title="branch not covered">options.port.toString() !== '443')</span> ||
       (<span class="branch-4 cbranch-no" title="branch not covered">!options._https_ </span>&amp;&amp; <span
                    class="branch-5 cbranch-no" title="branch not covered">options.port.toString() !== '80')</span>)) {
...
<span class="cstat-no" title="statement not covered">    return _.map(chunks, <span class="fstat-no"
                                                                                    title="function not covered">function(chunk) {</span></span>
...
<span class="cstat-no"
      title="statement not covered">  var responseBody = getBodyFromChunks(dataChunks, res.headers);</span>
&nbsp;
...
<span class="cstat-no"
      title="statement not covered">    var queries = req.path.slice(queryIndex + 1).split('&amp;');</span>
&nbsp;
...
&nbsp;
  ...
  var dont_print = (typeof rec_options === 'boolean' &amp;&amp; <span class="branch-1 cbranch-no"
                                                                      title="branch not covered">rec_options)</span> ||
...
&nbsp;
        ...
        //  invoke them.
<span class="cstat-no" title="statement not covered">        _.each(readableListeners, <span class="fstat-no"
                                                                                             title="function not covered">function(listener) {</span></span>
...
<span class="cstat-no" title="statement not covered">        res.read = <span class="fstat-no"
...
<span class="cstat-no" title="statement not covered">        var onReadable = <span class="fstat-no"
                                                                                    title="function not covered">function(data) {</span></span>
<span class="cstat-no"
      title="statement not covered">          debug(thisRecordingId, 'new readable data on', proto);</span>
<span class="cstat-no" title="statement not covered">          var chunk;</span>
          //  Use the prototypeRead function to actually read the data.
<span class="cstat-no"
      title="statement not covered">          while (null !== (chunk = prototypeRead.call(res))) {</span>
...
<span class="cstat-no"
      title="statement not covered">          debug(thisRecordingId, 'new', proto, 'body chunk');</span>
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Nov 17 2015
        09:42:41 GMT+0000 (GMT)
    </div>
</div>
